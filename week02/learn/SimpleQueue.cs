...
public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Trying to remove data from index 1 first rather than 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Program was trying to add values to front of the queue and not back
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //Defect 2 - Needs to add new value to the end of the queue not front
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //This queue should start at index 0 and not 1
        _queue.RemoveAt(0);
        return value;
    }
}